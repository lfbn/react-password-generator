...
// pakmanager:yargs-parser/lib/tokenize-arg-string
(function (context) {
  ...
  provide("yargs-parser/lib/tokenize-arg-string", module.exports);
}(global));
...
// pakmanager:password-generator/password-generator
(function (context) {
  ...
  provide("password-generator/password-generator", module.exports);
}(global));

// pakmanager:password-generator
(function (context) {
  ...
  module.exports =  require('password-generator/password-generator');
  provide("password-generator", module.exports);
}(global));

// pakmanager:react-password-generator
(function (context) {
  ...
  'use strict';
    ...
    var InputPasswordGenerator = function (_PureComponent) {
      _inherits(InputPasswordGenerator, _PureComponent);
    
      function InputPasswordGenerator(props) {
        _classCallCheck(this, InputPasswordGenerator);
    
        var _this = _possibleConstructorReturn(this, (InputPasswordGenerator.__proto__ || Object.getPrototypeOf(InputPasswordGenerator)).call(this, props));
    
        _this.handleOnFocus = _this.handleOnFocus.bind(_this);
        _this.handleOnBlur = _this.handleOnBlur.bind(_this);
        _this.handleGenerateOnClick = _this.handleGenerateOnClick.bind(_this);
        _this.state = {
          password: '',
      ...
      _createClass(InputPasswordGenerator, [{
        key: 'handleOnFocus',
    ...
    exports.default = InputPasswordGenerator;
  provide("react-password-generator", module.exports);
}(global));